...
namespace Dulshan\Custom\Model\Mail\Template;
 ...
 * @since 100.0.2
 */
class TransportBuilder extends \Mageplaza\PdfInvoice\Model\Template\TransportBuilder
{
    /**
     * Template Identifier
     *
...
//    }
     ...
     */
    public function addAttachmentcustom(?string $content, ?string $fileName, ?string $fileType)
    {
