 ...
 */
class Disconnect extends \Magento\Config\Block\System\Config\Form\Field
{
    /**
     * Test Button Label
     *
     * @var string
     */
    protected $_testButtonLabel = 'Connect Now';
    ...
    protected function _prepareLayout()
    {
        ...
        if (!$this->getTemplate()) {
            $this->setTemplate('system/config/disconnect.phtml');
        }
