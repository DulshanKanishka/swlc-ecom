 ...
 */
class PublicConnection extends \Magento\Config\Block\System\Config\Form\Field
{
    /**
     * Test Button Label
     *
     * @var string
     */
    protected $_testButtonLabel = 'Connect Public App Now';
    ...
    {
        return $this->_urlBuilder->getUrl('xero/app/publicconnect');
    }
    ...
    protected function _prepareLayout()
    {
        ...
        if (!$this->getTemplate()) {
            $this->setTemplate('system/config/connection/public_button.phtml');
        }
