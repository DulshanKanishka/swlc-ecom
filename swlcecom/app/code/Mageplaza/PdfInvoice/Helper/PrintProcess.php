...
//        }
        ...
        if(strpos($type, $word) !== false){
            if ($this->helperData->isEnablePageNumber($sid)) {
                $mpdf->setFooter('<h2 style="font-style: normal;font-weight: 500"> {PAGENO}/{nb} &nbsp;&nbsp;&nbsp;&nbsp;</h2>');
            }
        } else{
            if ($this->helperData->isEnablePageNumber($sid)) {
...
// Test if string contains the word
    ...
    public function createMpdf($pageSize)
    {
        ...
        $config            = [
            ...
            'fontdata'          => $fontData + [
                    ...
                    'lato'   => [
                        'R'  => 'DejaVu_Sans/DejaVuSansCondensed.ttf',
                        'B'  => 'DejaVuSansCondensed-Bold.ttf',
                        'I'  => 'DejaVu_Sans/DejaVuSansCondensed-Oblique.ttf',
                        'BI' => 'DejaVu_Sans/DejaVuSansCondensed-Oblique.ttf'
                    ]
                ],
            'default_font'      => 'lato',
            'orientation'       => 'P',
    ...
    public function addCustomTemplateVars($templateVars, $storeId)
    {
        ...
        $pickk = "Pick up from School/Club - Collection points";

        if (strpos($templateVars['order']->getShippingDescription(), $pickk) !== false ) {
            $templateVars['order']->setShippingDescription('Pick up from School/Club - Collection points');
        }
