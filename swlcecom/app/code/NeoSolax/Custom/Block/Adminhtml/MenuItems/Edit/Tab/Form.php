...
namespace NeoSolax\Custom\Block\Adminhtml\MenuItems\Edit\Tab;
...
class Form extends \Sm\MegaMenu\Block\Adminhtml\MenuItems\Edit\Tab\Form
{
    protected $_wysiwygConfig;

    public function __construct(Context $context, Registry $registry, ObjectData $dataObject, FormFactory $formFactory, Store $systemStore, Layout $layout, Data $backendData, ObjectManagerInterface $objectManagerInterface, Config $wysiwygConfig, array $data = [])
    {
    ...
    protected function _prepareForm()
    {
         ...
         * Form sortable items
         * */
        $fieldset2 = $form->addFieldset('form_sortable', [
