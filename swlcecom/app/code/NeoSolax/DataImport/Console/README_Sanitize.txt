...
#Truncate Vessel Tables
TRUNCATE TABLE `vessel`;
TRUNCATE TABLE `vessel_container`;
TRUNCATE TABLE `vessel_quote_list`;
TRUNCATE TABLE `vessel_shared_info`;
TRUNCATE TABLE `vessel_shipping_domestic_fcl`;
TRUNCATE TABLE `vessel_shipping_domestic_lcl`;
TRUNCATE TABLE `vessel_shipping_domestic_port`;
TRUNCATE TABLE `vessel_shipping_international_fcl`;
TRUNCATE TABLE `vessel_shipping_international_lcl`;
TRUNCATE TABLE `vessel_shipping_international_port`;
