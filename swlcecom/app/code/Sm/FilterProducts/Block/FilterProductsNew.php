...
class FilterProductsNew extends \Magento\Catalog\Block\Product\AbstractProduct
{
    ...
    {
        if (!(int)$this->_getConfig('enable', 1)) {
            return;
        }
    ...
    private function _countDownProducts()
    {
        ...
        $category_id = $this->_getConfig('select_category_new');
        ...
        if (!empty($category_id) && $category_id) {
            $collection->joinField(
                ...
                null,
                'left'
            )->addAttributeToFilter([['attribute' => 'category_id', 'in' => [ $category_id]]]);
        }
    ...
    public function getAddToCartPostParams(\Magento\Catalog\Model\Product $product)
    {
        ...
        return [
            ...
            'data' => [
                ...
                \Magento\Framework\App\ActionInterface::PARAM_NAME_URL_ENCODED => $this->_objectManager->get('\Magento\Framework\Url\Helper\Data')->getEncodedUrl($url),
            ]
        ];
    }
}
