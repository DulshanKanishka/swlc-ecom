...
define([
    ...
    $.widget('smileEs.quickSearch', $.mage.quickSearch, {
        ...
        _getSectionHeader: function (type, data) {
            var title = '';
            if (type === 'term') {
                var header = $('<dl role="listbox" class="elas-term autocomplete-list"></dl>');
            } else if (type === 'product') {
                var header = $('<dl role="listbox" class="elas-product autocomplete-list"></dl>');
            } else if (type === 'category') {
                var header = $('<dl role="listbox" class="elas-category autocomplete-list"></dl>');
            } else {
