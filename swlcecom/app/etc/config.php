...
return [
    'modules' => [
        ...
        'Meetanshi_PaymentRestriction' => 1,
        'Mopinion_FeedbackSurvey' => 1,
        'Smile_ElasticsuiteCore' => 1,
        'NeoSolax_CustomComment' => 1,
        'NeoSolax_DataImport' => 1,
        'NeoSolax_QuickBooksOnline' => 1,
        'NeoSolax_SalesRule' => 1,
        'NeoSolax_ShelfLocation' => 1,
        ...
        'WebPanda_ConfigurablePriceRange' => 1,
        ...
        'Sunflowerbiz_CategoryPassword' => 1,
        'Telr_TelrPayments' => 1,
